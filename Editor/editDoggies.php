...
<body>
<div id="allcontent" style="height:100%; padding-top:10px;">
...
$query = "INSERT INTO dogs VALUES($id, '$name', '$age', '$h1', '$h2', '$pic', '$bio', 'NULL')";

move_uploaded_file($_FILES['pic']['tmp_name'], "..".$PIC_PATH.$pic);
if (!mysql_query($query, $db_server))
...
echo <<<_END
<table>
  <form action="editDoggies.php" method="post" enctype="multipart/form-data"><pre>
<tr><td> <label for="name"> Name </label> <input type="text" id="name" name="name">       </td></tr>
<tr><td> <label for="age"> Age </label> <input type="text" id="age" name="age">       </td></tr>
<tr><td> <label for="h1"> Headline </label><input type="text" id="h1" name="h1" maxlength="15">    </td></tr>
<tr><td> <label for="h2"> Subhead </label><input type="text" id="h2" name="h2">    </td></tr>
<tr><td> <label for="pic"> Photo </label><input type="file" id="pic"name="pic">  </td></tr>
<tr><td> <label for="bio"> Bio</label><textarea type="text" id="bio" name="bio" cols="50" rows="15"></textarea></td></tr>
...
<table class="DATA">
 ...
 <tr><td class="label">  Age </td> <td class="value"> $row[2] </td></tr>
 <tr><td class="label">  Head </td> <td class="value"> $row[3] </td></tr>
 <tr><td class="label">  Sub </td> <td class="value"> $row[4] </td></tr>
 <tr><td class="label">  Photo </td> <td class="value">
    <img style="width:250px;" src="..$PIC_PATH$row[5]">
 </td></tr>
 <tr><td class="label">  Bio </td> <td class="value"> $row[6] </td></tr>
  
   <tr><td></td><td>
   <form action="editDoggies.php" method="post">
  <input type="hidden" name="delete" value="yes">
  <input type="hidden" name="id" value="$row[0]">
  <input type="hidden" name="photo" value="$row[5]">
...
function get_post($var) {
  ...
  return sanitize(lineBreaksEncode($_POST[$var]));
}
